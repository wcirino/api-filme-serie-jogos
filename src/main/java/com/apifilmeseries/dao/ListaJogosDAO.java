...
public class ListaJogosDAO {
    ...
    public List<ListaGamesDTO> consultarListaJogosPorUsuarioEType(Long idUsuario, String tipoAcao) {
        ...
        sqlBuilder.append("SELECT ")
                ...
                .append("INNER JOIN usuarios u ON l.id_usuario = u.id ")
                .append("INNER JOIN games g ON l.id_jogo = g.id_jogo ")
                .append("WHERE l.id_usuario = :idUsuario AND l.tipo_acao = :tipoAcao");
